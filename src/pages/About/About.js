    ...
    <div className="aboutPage">
      ...
      <div className="about-page-bio">
        ...
        <h5 className="about-page-text1">
          Born and raised in Turkey. I studied Business and Hotel Management at
          one of the biggest university in South of Turkey. And then came to
          United States back in 2015. It was a great experience as a front desk
          agent and as a supervisor at one of the best hotel in Fort Lauderdale,
          FL. I would say, It was an amazing feeling that my talents has been
          seen, all the way from overseas. After a year, contract ended, but my
        ...
        <div className="education">
          ...
          <h6 className="about-page-education">
            Software Engineering Immersive | Full Stack Web Developer | AUSTIN,
            TX | OCTOBER 2021-MARCH 2022
          </h6>
        ...
        <div className="experiences">
          ...
          <h5 className="about-page-experience">
            ...
            <br></br>● Developed projects, including a game called “CARD OF WAR”
            using HTML, CSS, JavaScript.<br></br>● LavenWoods Alchemy (Developed
            within a group of 4 people)<br></br>● Node.js, Express, MangoDB and
            Mongoose. It’s also a full CRUD project with a RESTful layout.
            <br></br>● SportForLife-ReactJS, bootstrap, API technology, Express,
            Heroku for deployment.<br></br>● RightAway-Python, Django and SQL
            database.
          </h5>
        </div>
